...
═══════════════════════════════════════════════════════════════════
  ...
  /landing-content         — 07.  Адаптировать текст прототипа в
                                  Gutenberg-блоки.
  /landing-wireframe       — 07a. Интерактивный wireframe.html, выбор
                                  вариантов блоков радиокнопками.
...
УТИЛИТЫ
═══════════════════════════════════════════════════════════════════
  /landing-import-blocks        — Импорт блоков с URL (сайт/PDF) в
                                  block-library через codex CLI vision.
