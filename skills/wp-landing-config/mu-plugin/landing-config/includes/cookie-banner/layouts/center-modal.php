...
?>
<div class="lp-cb__backdrop"></div><div id="lp-cb" class="lp-cb lp-cb--center-modal" data-version="<?php echo esc_attr($settings['consent_version']); ?>" hidden role="dialog" aria-labelledby="lp-cb-title">
