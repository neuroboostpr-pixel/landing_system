...
?>
<div id="lp-cb" class="lp-cb lp-cb--floating-card-right" data-version="<?php echo esc_attr($settings['consent_version']); ?>" hidden role="dialog" aria-labelledby="lp-cb-title">
